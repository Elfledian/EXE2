...
namespace FastWork.Migrations
{
    ...
    [Migration("20250520192425_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FastWork.Entities.Application", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.Candidate", b =>
                {
                    b.Property<Guid>("CandidateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("FastWork.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.Company", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.CvDetail", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.File", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.Invitation", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.Job", b =>
                {
                    b.Property<Guid>("JobId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("FastWork.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.Payment", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.Rating", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.Recruiter", b =>
                {
                    b.Property<Guid>("RecruiterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("FastWork.Entities.Subscription", b =>
                {
                    b.Property<Guid>("SubscriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("FastWork.Entities.Tag", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.User", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("FastWork.Entities.Verification", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.WorkHistory", b =>
                {
            ...
            modelBuilder.Entity("FastWork.Entities.Application", b =>
                {
                    b.HasOne("FastWork.Entities.Candidate", "Candidate")
                        .WithMany("Applications")
                        .HasForeignKey("CandidateId")
                        .HasConstraintName("FK__applicati__candi__03F0984C");

                    b.HasOne("FastWork.Entities.Job", "Job")
                        .WithMany("Applications")
                        .HasForeignKey("JobId")
            ...
            modelBuilder.Entity("FastWork.Entities.Candidate", b =>
                {
                    b.HasOne("FastWork.Entities.User", "User")
                        .WithOne("Candidate")
                        .HasForeignKey("FastWork.Entities.Candidate", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("FastWork.Entities.Company", b =>
                {
                    b.HasOne("FastWork.Entities.File", "LogoFile")
                        .WithMany("Companies")
                        .HasForeignKey("LogoFileId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_companies_files");

                    b.HasOne("FastWork.Entities.User", "Recruiter")
                        .WithOne("Company")
                        .HasForeignKey("FastWork.Entities.Company", "RecruiterId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("FastWork.Entities.Invitation", b =>
                {
                    ...
                    b.HasOne("FastWork.Entities.Recruiter", "Recruiter")
                        .WithMany("Invitations")
            ...
            modelBuilder.Entity("FastWork.Entities.Job", b =>
                {
                    b.HasOne("FastWork.Entities.Category", "Category")
                        .WithMany("Jobs")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK__jobs__category_i__778AC167");

                    b.HasOne("FastWork.Entities.Company", "Company")
                        .WithMany("Jobs")
                    ...
                    b.HasOne("FastWork.Entities.Subscription", "Subscription")
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("FastWork.Entities.Payment", b =>
                {
                    b.HasOne("FastWork.Entities.Application", "Application")
                        .WithOne("Payment")
                        .HasForeignKey("FastWork.Entities.Payment", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("FastWork.Entities.Rating", b =>
                {
                    b.HasOne("FastWork.Entities.User", "Reviewer")
                        .WithMany("Ratings")
            ...
            modelBuilder.Entity("FastWork.Entities.Recruiter", b =>
                {
                    b.HasOne("FastWork.Entities.User", "User")
                        .WithOne("Recruiter")
                        .HasForeignKey("FastWork.Entities.Recruiter", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("FastWork.Entities.Verification", b =>
                {
                    b.HasOne("FastWork.Entities.User", "User")
                        ...
                        .HasForeignKey("FastWork.Entities.Verification", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("JobTag", b =>
                {
                    b.HasOne("FastWork.Entities.Job", null)
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("FastWork.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("FastWork.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
